          ...
          <div className="login-box">
            ...
            <a onClick={() => navigate("/create-user")} style={{ marginTop: "1rem", cursor:"pointer"}}>
              ...
              <div className="login-separator">
                <p className="login-separator-text" style={{fontSize:'14px'}}>
                  Puedes inciar sección con </p>
              </div>
              <div className="options-register">
                ...
                <a onClick={() => navigate("/quiz")} style={{ marginTop: "1rem", cursor:"pointer"}}>
                  <span>
                      <u>Seguir sin iniciar sesión</u>
                    </span>
                </a>
            </div>
          </div>
