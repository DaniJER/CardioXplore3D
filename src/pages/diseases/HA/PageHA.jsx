                ...
                items={[
                    {
                        ...
                        description: "Mejorar la dieta, hacer ejercicio y reducir el consumo de sal y alcohol.",
                    },
                    {
                        title: "Medicamentos",
                        description: "Uso de fármacos como diuréticos, betabloqueantes o inhibidores de la ECA.",
                    },
                    {
                        title: "Monitoreo de presión",
                        description: "Controlar regularmente los niveles de presión arterial en casa o en consulta.",
                    },
                    {
                        title: "Reducción del estrés",
                        description: "Aplicar técnicas de relajación como yoga, meditación o respiración profunda.",
                    },
                    {
                        title: "Suplementos",
                        description: "Uso de suplementos como potasio o magnesio, siempre con supervisión médica.",
                    },
                ]}
                Model3D={Tablets}
                scale={0.78}
